...
|                                          | 1.3 Ohjelmointiympäristö kuntoon                                                                        | Rider, hakemistorakenne, solution, projekti                                                       | v1 valmis, tehtävät puuttuvat           |
|                                          | 1.4 Ensimmäinen graafinen ohjelma                                                                       | Jypeli-esimerkki, projektimallit, Main, Content                                                   | v1 valmis, tehtävät puuttuvat           |
| **2 Muuttujat, ehdot ja aliohjelmat**    | 2.1 Muuttujat ja tietotyypit                                                                            | muuttuja, tyypit, var, vakiot                                                                     | v1 valmis, tehtävät puuttuvat           |
|                                          | 2.2 Operaattorit ja laskutoimitukset                                                                    | aritmetiikka, kokonaislukujako, laskujärjestys, cast lyhyesti, vertailu, loogiset, sijoitus, Math | v1 valmis, tehtävät puuttuvat           |
...
|                                          | 2.5 Lauseet ja lausekkeet                                                                               | lause vs. lauseke                                                                                 | v1 valmis, tehtävät puuttuvat           |
