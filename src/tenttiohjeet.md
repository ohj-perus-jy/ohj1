...
Tämä sivu sisältää [Jyväskylän yliopiston ohjeet verkkotenttien suorittamiseen](#jy-tenttiohjeet) sekä [tarkentavat ohjeet opintojakson Ohjelmointi 1 (ITKP102) -tenttiin](#ohj1-tenttiohjeet).
...
## 2. Tarkentavat ohjeet opintojakson Ohjelmointi 1 (ITKP102) -tenttiin {#ohj1-tenttiohjeet}
...
- Tentin aikana opiskelijan tulee [jakaa kaikkien näyttöjen ruutukuvat](https://support.zoom.com/hc/en/article?id=zm_kb&sysparm_article=KB0074632) sekä videokuvan itsestään.
  Tarvittavan laitteiston hankinta on opiskelijan vastuulla. Videokamerana on sallittua käyttää oman puhelimen kameraa.
