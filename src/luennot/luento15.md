 ...
 * **Lue:** [8.3 Oliotietotyyppien ja alkeistietotyyppien ero](https://tim.jyu.fi/view/kurssit/tie/itkp102/materiaali/moniste#WbRwxc1yrw0v)
 * **Valinnaista lisätietoa**: (Erään laskutavan mukaan) x86-64 arkkitehtuurille käännetty ohjelma voi käyttää [noin 600 erilaista rekisteriä](https://blog.yossarian.net/2020/11/30/How-many-registers-does-an-x86-64-cpu-have)
   ...
   * Tavallinen x86-64-arkkitehtuurille käännetty tietokoneohjelma käyttää laskentaan lopuksi noin 20-40 [yleisrekisteriä ja niiden alirekistereitä](https://sandpile.org/x86/gpr.htm), liukulukurekistereitä ja nykyään jotain vektorirekistereitä
